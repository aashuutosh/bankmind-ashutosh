# BankMind Cross-Sell Analytics Dashboard (Track A)
...
* `EXPLANATION.md`: Answers to the analytical business questions based on the dataset.
* `requirements.txt`: The Python dependencies required to run the dashboard.
...
1. Clone this repository to your local machine:
   ```bash
   git clone [https://github.com/yourusername/bankmind-ashutosh.git](https://github.com/yourusername/bankmind-ashutosh.git)